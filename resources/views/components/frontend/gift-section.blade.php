<section class="position-relative my-5" style="height: calc(100vh - 200px);">
    <img src="{{ asset('images/frontend/gift.webp') }}" alt="Gift Background"
