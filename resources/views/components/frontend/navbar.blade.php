...
<div style="position: fixed; top: 0; left: 0; width: 100%; background-color: #2e2e2e;height: 36px;color: #bc9a69; text-align: center; padding: 10px 0; z-index: 9999;font-size: 14px;font-family: 'IBM Plex Sans Arabic', sans-serif !important;font-weight: bold;line-height: 1.25rem;">
    ...
    <button onclick="this.parentElement.style.display='none'" style="position: absolute; right: 10px; top: 5px; background-color: rgba(255,255,255,0.05); border: none; border-radius: 6px; padding: 4px 6px; cursor: pointer;">
        <svg style="width: 12px; height: 12px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="xmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            <path fill="#BC9A69" d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/>
        </svg>
    </button>
</div>
<div class="position-absolute top-0 start-0 w-100" style="z-index: 6; margin-top: 46px;">
    <div class="container" style="padding: 0 5rem ">
        <div class="d-flex justify-content-center flex-wrap justify-content-md-between flex-md-row flex-row-reverse gap-3">
            <div class="d-flex align-items-center gap-4 order-1 order-md-0">
                <a href="https://api.whatsapp.com/send/?phone=966504470706&text&type=phone_number&app_absent=0" class="rounded-circle p-2 d-flex align-items-center justify-content-center nav-social-icons "
                    style="background-color:#ffffff1a; cursor: pointer; width: 40px;border-radius: 50%; height: 40px">
                    <svg data-v-49efcba9="" style="width: 18px; height: 18px" aria-hidden="true" focusable="false"
                        data-prefix="fab" data-icon="whatsapp" role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512">
                        <path class="" fill="white"
                            d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.1 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z">
                        </path>
                    </svg>
                </a>
                ...
                <a href="https://x.com/Jospa_sa" class="rounded-circle p-2 d-flex align-items-center justify-content-center nav-social-icons"
                    style="background-color:#ffffff1a; cursor: pointer; width: 40px;border-radius: 50%; height: 40px">
            ...
            <div class="d-flex align-items-center gap-3" style="font-weight: bold;">
                <div class="d-flex align-items-center gap-1">
                    <span class="rounded-circle p-2 d-flex align-items-center justify-content-center">
                        <svg data-v-49efcba9="" style="width: 16px" class="svg-inline--fa fa-envelope" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path class="" fill="white" d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"></path></svg>
                    </span>
                        <a data-v-9f8aecdc="" href="mailto:info@jospa-sa.com" style="color: white;">info@jospa-sa.com </a>
                </div>
                <div class="d-flex align-items-center gap-1">
                    <span class="rounded-circle p-2 d-flex align-items-center justify-content-center">
