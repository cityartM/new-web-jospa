    ...
    <div class="position-absolute start-50 translate-middle-x w-100 d-flex justify-content-center px-5" style="bottom: 25px;">
        <div class="d-flex gap-3 text-white w-100 justify-content-center">
            ...
            @if(isset($category_id))
                <a href="{{ route('frontend.category.details', $category_id) }}" class="btn btn-light rounded-pill px-4 py-2 col-6 text-center m-0 d-flex align-items-center justify-content-center">Details</a>
            @else
                <a href="#" class="btn btn-light rounded-pill px-4 py-2 col-6 text-center m-0 d-flex align-items-center justify-content-center">Details</a>
            @endif
        </div>
    </div>
</div>
